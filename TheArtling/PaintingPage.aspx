<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/HeadAndFooter.Master" CodeBehind="PaintingPage.aspx.cs" Inherits="TheArtling.PaintingPage" %>
        ...
        <div class="parent">
            <div class="left">
                <div style="font-size: 20px; font-weight: 600;">
                    Original Contemporary Painting for Sale
                </div>
                <br />
                            ...
                            <td>
                                <div class="filter">
                                    ...
                                    <div>
                                        ...
                                        <asp:SqlDataSource ID="CategoryDatabase" runat="server" ConnectionString="<%$ ConnectionStrings:ArtConnectionString %>" SelectCommand="SELECT * FROM [Category] WHERE [ProductType]='Painting'"></asp:SqlDataSource>
                                    </div>
                                    <div style="height: 10px; border-bottom: 2px dashed #D2D9D5"></div>
                                    <br />
                                    <div>
                                ...
                                <div class="product-holder">
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <ItemTemplate>
                                            ...
                                            <a href="/ProductCart.aspx?Id=<%# Eval("ProductID") %>">
